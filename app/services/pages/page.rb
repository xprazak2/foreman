module Pages
  class Page < ViewItem
    ...
    #   fail "This view item already has columns, no tabs can be added" if @columns.any?
    ...
    # def add_widget(opts)
    #   if page.tabbed?
    #     fail "Page '#{name}' is tabbed, you can add widgets to tabs, not directly to page"
    #   else
    ...
    #to force all widgets into tabs
    # def tabify(tab_name)
