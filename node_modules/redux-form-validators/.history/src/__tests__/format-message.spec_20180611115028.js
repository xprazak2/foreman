...
var formatMessage = Validators.formatMessage

describe('formatMessage', function() {
  it('should return the default value or id', function() {
    assert.equal('foo', Validators.formatMessage({ defaultMessage: 'foo', id: 'bar' }))
    assert.equal('bar', Validators.formatMessage({ id: 'bar' }))
  })
